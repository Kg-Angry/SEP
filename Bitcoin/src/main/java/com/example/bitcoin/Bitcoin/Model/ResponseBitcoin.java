...
public class ResponseBitcoin {
    ...
    public ResponseBitcoin() {
    }

    public ResponseBitcoin(Long id, String status, String price_currency, String price_amount, String receive_currency, String receive_amount, String created_at, String order_id, String payment_url, String token) {
        this.id = id;
        this.status = status;
