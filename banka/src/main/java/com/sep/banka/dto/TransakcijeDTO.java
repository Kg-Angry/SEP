...
public class TransakcijeDTO {
    ...
    public TransakcijeDTO( String idTransakcije, String uuid, String naziv, String vremeKreiranjaTransakcije, String status, String uplatilac, String tipPlacanja, String orderId, Double cena) {
